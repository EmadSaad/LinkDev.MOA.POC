...
import { InfrastructurePermitRoutingModule } from './Infrastructure-Permit-routing.model';
...
@NgModule({
  imports: [
    CommonModule,
    InfrastructurePermitRoutingModule,
    BreadcrumbModule,
    FormHierarchyModule,
    TranslateModule,
    FormsModule,
...
export class InfrastructurePermitModule { }
