...
export class CreateCaseComponent implements OnInit {
  ...
  submitRequest(){  this.submit = true;
    ...
    return this.Application.Request.TotalPrice=0;
  }


  get SetImportingDocuments():DocumentSettingModel[]{

    let Documents:DocumentSettingModel[]=[{Id:"ccb5ecd9-e11d-eb11-a9ec-000d3aaa6848",Name:"نموذج الأستيراد ",Description: null,IsRequired: true,MinAllowedFiles: 1,MaxAllowedFiles: 1,AllowedSize: 10240,AllowedExtensions: "PDF,XLSX,XLS,DOCX,PNG,DOC,JPG,JPEG",SectionName: null,DependentFields:[],TemplateId: null,Files:[],Errors:[],IsVisible: true},
   {Id:"ccb5ecd9-e11d-eb11-a9ec-000d3aaa6848",Name:"طلب بأسم السيد رئيس اللجنة ، شارحا فيه الكميات و الأصناف و السعر",Description: null,IsRequired: false,MinAllowedFiles: 0,MaxAllowedFiles: 1,AllowedSize: 10240,AllowedExtensions: "PDF,XLSX,XLS,DOCX,PNG,DOC,JPG,JPEG",SectionName: null,DependentFields:[],TemplateId: null,Files:[],Errors:[],IsVisible: true},
   {Id:"ccb5ecd9-e11d-eb11-a9ec-000d3aaa6848",Name:"فاتورة مبدئية",Description: null,IsRequired: false,MinAllowedFiles: 0,MaxAllowedFiles: 1,AllowedSize: 10240,AllowedExtensions: "PDF,XLSX,XLS,DOCX,PNG,DOC,JPG,JPEG",SectionName: null,DependentFields:[],TemplateId: null,Files:[],Errors:[],IsVisible: true},
   {Id:"ccb5ecd9-e11d-eb11-a9ec-000d3aaa6848",Name:"صورة سجل المستوردين",Description: null,IsRequired: false,MinAllowedFiles: 0,MaxAllowedFiles: 1,AllowedSize: 10240,AllowedExtensions: "PDF,XLSX,XLS,DOCX,PNG,DOC,JPG,JPEG",SectionName: null,DependentFields:[],TemplateId: null,Files:[],Errors:[],IsVisible: true},
   {Id:"ccb5ecd9-e11d-eb11-a9ec-000d3aaa6848",Name:"صورة ترخيص الأتجار في التقاوي",Description: null,IsRequired: false,MinAllowedFiles: 0,MaxAllowedFiles: 1,AllowedSize: 10240,AllowedExtensions: "PDF,XLSX,XLS,DOCX,PNG,DOC,JPG,JPEG",SectionName: null,DependentFields:[],TemplateId: null,Files:[],Errors:[],IsVisible: true},
   {Id:"ccb5ecd9-e11d-eb11-a9ec-000d3aaa6848",Name:"(أمانة لجنة التقاوي)إيصال سداد 0.1% من قيمة الفاتورة",Description: null,IsRequired: false,MinAllowedFiles: 0,MaxAllowedFiles: 1,AllowedSize: 10240,AllowedExtensions: "PDF,XLSX,XLS,DOCX,PNG,DOC,JPG,JPEG",SectionName: null,DependentFields:[],TemplateId: null,Files:[],Errors:[],IsVisible: true}]
   return Documents;
  }
