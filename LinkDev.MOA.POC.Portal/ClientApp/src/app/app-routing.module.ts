...
import { ScreenInvestmentLicenseModule } from "src/modules/Screen-Investment-License/Screen-Investment-License.module";
...
const routes: Routes = [
  ...
  { path: 'ecza-services', loadChildren: 'src/modules/Portal-Services/portal-services.module#PortalServicesModule' },
...
{ path:'moa-cases', loadChildren: 'src/modules/MOA-Cases/moa-cases.module#MoaCasesModule', canActivate: []},
  ...
  {path: 'ecza-payment',loadChildren:'src/modules/moa-payment/moa-payment.module#MOAPaymentModule',canActivate:[]},
  ...
  {path:'infrastructure-permit', loadChildren:'src/modules/Infrastructure-Permit/Infrastructure-Permit.module#InfrastructurePermitModule', canActivate: []},
  {path:'screeninvestment-license', loadChildren:'src/modules/Screen-Investment-License/Screen-Investment-License.module#ScreenInvestmentLicenseModule', canActivate: []},
