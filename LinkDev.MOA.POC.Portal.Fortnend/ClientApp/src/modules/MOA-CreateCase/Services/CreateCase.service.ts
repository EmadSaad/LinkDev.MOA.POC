...
export class CreateCaseService {
  private baseUrl: string = "https://moa.westeurope.cloudapp.azure.com/apis/api/";
  private getUrl: string = "https://moa.westeurope.cloudapp.azure.com/apis/api/Lookups/CompaniesLookups";
  private postUrl: string = "https://moa.westeurope.cloudapp.azure.com/apis/api/Requests/PostCase";
