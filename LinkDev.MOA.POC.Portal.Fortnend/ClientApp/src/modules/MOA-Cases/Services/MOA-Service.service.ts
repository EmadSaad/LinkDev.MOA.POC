...
export class MOAService {
  ...
  private MOACasesUrl = 'https://moa.westeurope.cloudapp.azure.com/apis/api/Requests/GetRequests';
...
getCaseStatistics():Observable<CaseStatistics>{
  return this.api.Get<CaseStatistics>("https://moa.westeurope.cloudapp.azure.com/apis/api/Requests/CaseStatistics").pipe();
}
}
