...
export class MoaPaymentService implements IRequestService<CaseModel> {
  ...
  private getUrl: string = "https://moa.westeurope.cloudapp.azure.com/apis/api/Requests/GetPayment?";
  private postUrl: string = "https://moa.westeurope.cloudapp.azure.com/apis/api/Requests/PostPayment";
