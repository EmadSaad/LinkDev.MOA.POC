...
import { CoordinationLetterRoutingModule } from '../Coordination-Letter/Coordination-Letter-routing.module'
...
@NgModule({
 imports: [
   ...
   BreadcrumbModule,
   CoordinationLetterRoutingModule
 ],
 declarations: [CoordinationLetterComponent]
})
export class CoordinationLetterModule { 
