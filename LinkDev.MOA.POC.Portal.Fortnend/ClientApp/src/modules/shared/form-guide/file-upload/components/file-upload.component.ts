...
export class FileUploadComponent  implements OnInit, OnDestroy {
    ...
    public documentURL: string="https://moa.westeurope.cloudapp.azure.com/apis/api/documents/upload?folderName=";
...
console.log(currentFile);
        ...
        this.documentURL="https://moa.westeurope.cloudapp.azure.com/apis/api/payment/upload?folderName=";
