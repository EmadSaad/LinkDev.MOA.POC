...
import { OperatingLicenseRequestRoutingModule } from './operating-license-request.routing.module';
...
@NgModule({
  imports: [
    CommonModule,
    BiddingModule,
    OperatingLicenseRequestRoutingModule,
    FormsModule,
    TextBoxModule,
    MutliselectModule,
    GridModule,
...
export class OperatingLicenseRequestModule { }
