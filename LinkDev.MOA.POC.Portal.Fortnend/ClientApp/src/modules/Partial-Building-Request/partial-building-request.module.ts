...
import { PartialBuildingRequestRoutingModule } from './partial-building-request.routing.module';
...
@NgModule({
  imports: [
    CommonModule,
    BiddingModule,
    PartialBuildingRequestRoutingModule,
    FormsModule,
    TextBoxModule,
    MutliselectModule,
    GridModule,
...
export class PartialBuildingRequestModule { }
